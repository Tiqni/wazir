...
**Tech Stack:** Go 1.22, `google/go-github/v66`, `shurcooL/githubv4`, `golang.org/x/oauth2`, `bradleyfalzon/ghinstallation/v2` (scaffold), `go.etcd.io/bbolt`, `caarlos0/env/v11`, stdlib `flag`/`net/http`/`log/slog`.
